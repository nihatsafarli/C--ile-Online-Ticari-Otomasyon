...
namespace Ticari_Otomasyon
{
    public partial class FrmUrunler : Form
    {
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            sil = MessageBox.Show("Ürün Sistemden Silinecek,Onaylıyor musunuz?", "Soru", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Ürün Sistemde Başarıyla Güncellendi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
